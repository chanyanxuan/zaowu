        ...
        <FileSheetSubsection title="动画">
          ...
          <FileSheetButtonRow columns={2}>
            <Button
              ...
              disabled={!enabled}
              aria-label={`${animationState.playing ? "暂停" : "播放"} ${label} 动画`}
              title={`${animationState.playing ? "暂停" : "播放"} ${label} 动画`}
            >
              ...
              <span>{animationState.playing ? "暂停" : "播放"}</span>
            </Button>
            <Button
              type="button"
              variant="outline"
